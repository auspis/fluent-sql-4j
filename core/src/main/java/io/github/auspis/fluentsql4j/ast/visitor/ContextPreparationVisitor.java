...
public class ContextPreparationVisitor implements Visitor<AstContext> {
    ...
    public AstContext visit(Where clause, AstContext ctx) {
        if (clause.condition() == null
                || clause.condition() instanceof io.github.auspis.fluentsql4j.ast.core.predicate.NullPredicate) {
            return ctx;
        }
    ...
    @Override
    public AstContext visit(TruncateStatement truncateStatement, AstContext ctx) {
        return ctx;
    }
