 ...
 * <ul>
 *   <li>{@link io.github.massimiliano.fluentsql4j.ast.core.expression.scalar.ScalarExpression} - produces a value
 *       per row
 *   <li>{@link io.github.massimiliano.fluentsql4j.ast.core.expression.aggregate.AggregateExpression} - produces
 *       a value per group
 * </ul>
 *
 ...
 * </ul>
 *
 * <p>Note: {@link io.github.massimiliano.fluentsql4j.ast.core.predicate.Predicate} and
 * {@link io.github.massimiliano.fluentsql4j.ast.core.expression.set.SetExpression} do NOT extend ValueExpression
