...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.AsPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.BetweenPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.BinaryArithmeticExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.CastPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.CharLengthPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.CharacterLengthPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.ColumnReferencePsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.ComparisonPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.ConcatPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.DeleteStatementPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.FromSubqueryPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.GroupByClausePsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.HavingClausePsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.InPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.IndexDefinitionPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.InsertSourcePsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.InsertStatementPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.IntervalPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.IsNotNullPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.IsNullPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.JsonExistsPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.JsonQueryPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.LeftPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.LengthPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.LikePsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.MergeUsingPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.ModPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.NotNullConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.NotPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.NtilePsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.NullSetExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.OnJoinPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.OrderByClausePsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.ScalarExpressionProjectionPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.SelectStatementPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.TablePsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.TrimPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.UnaryArithmeticExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.UnaryNumericPsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.UniqueConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.UpdateItemPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.UpdateStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.WhenMatchedDeletePsStrategy;
...
import io.github.massimiliano.fluentsql4j.ast.visitor.ps.strategy.WhereClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlAggregateCallPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlAggregationFunctionProjectionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlAliasedTableExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlAndOrPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlAsPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlBetweenPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlBinaryArithmeticExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCastPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCharLengthPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCharacterLengthPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCheckConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlColumnDefinitionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlColumnReferencePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlComparisonPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlConcatPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCreateTableStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCurrentDatePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlCurrentDateTimePsStrategy;
...
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlDateArithmeticPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlDefaultConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlDefaultValuesPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlDeleteStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlDenseRankPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlEscapeStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlExceptExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlExtractDatePartPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlForeignKeyConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlFromClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlFromSubqueryPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlGroupByClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlHavingClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlInPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlIndexDefinitionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlInsertSourcePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlInsertStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlInsertValuesPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlIntersectExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlIntervalPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlIsNotNullPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlIsNullPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlJsonExistsPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlJsonQueryPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlJsonValuePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLagPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLeadPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLeftPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLengthPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLikePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlLiteralPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlMergeStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlMergeUsingPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlModPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNotNullConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNotPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNtilePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNullPredicatePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNullScalarExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlNullSetExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlOnJoinPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlOrderByClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlOverClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlPaginationPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlParameterizedDataTypePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlPowerPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlPrimaryKeyPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlRankPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlReferencesItemPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlReplacePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlRoundPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlRowNumberPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlScalarExpressionProjectionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlScalarSubqueryPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlSelectClausePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlSelectStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlSimpleDataTypePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlSortingPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlSubstringPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlTableDefinitionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlTablePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlTrimPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUnaryArithmeticExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUnaryNumericPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUnaryStringPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUnionExpressionPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUniqueConstraintPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUpdateItemPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlUpdateStatementPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlWhenMatchedDeletePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlWhenMatchedUpdatePsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlWhenNotMatchedInsertPsStrategy;
import io.github.massimiliano.fluentsql4j.plugin.builtin.sql2016.ast.visitor.ps.strategy.StandardSqlWhereClausePsStrategy;
