...
class AstToPreparedStatementSpecVisitorTest {
    ...
    void testSelectInnerJoin() {
        ...
        var specFactory = new io.github.auspis.fluentsql4j.ast.visitor.PreparedStatementSpecFactory(
                io.github.auspis.fluentsql4j.ast.visitor.ps.AstToPreparedStatementSpecVisitor.builder()
                        .build());
    ...
    void testSelectSumGroupByHavingAnd() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.auspis.fluentsql4j.ast.dql.clause.Having.of(
                        io.github.auspis.fluentsql4j.ast.core.predicate.AndOr.and(
    ...
    void testSelectGroupByHavingBetween() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.auspis.fluentsql4j.ast.dql.clause.Having.of(
                        new io.github.auspis.fluentsql4j.ast.core.predicate.Between(
    ...
    void testSelectGroupByHavingIn() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.auspis.fluentsql4j.ast.dql.clause.Having.of(
                        new io.github.auspis.fluentsql4j.ast.core.predicate.In(
