...
class StandardSqlFromSubqueryPsStrategyTest {
    ...
    void handleFromSubqueryWithAlias() {
        var subquery = SelectStatement.builder()
                ...
                .from(io.github.massimiliano.fluentsql4j.ast.dql.clause.From.of(new TableIdentifier("User")))
                .build();
        ...
        var subquery = SelectStatement.builder()
                ...
                .where(io.github.massimiliano.fluentsql4j.ast.dql.clause.Where.of(
                        io.github.massimiliano.fluentsql4j.ast.core.predicate.Comparison.eq(
                                ...
                                io.github.massimiliano.fluentsql4j.ast.core.expression.scalar.Literal.of("John"))))
                .build();
