...
import io.github.massimiliano.fluentsql4j.ast.core.expression.scalar.ArithmeticExpression;
...
class AstToPreparedStatementSpecVisitorTest {
    ...
    void testInsertStatement() {
        ...
        PreparedStatementSpec result = specFactory.visit(insertStatement, new AstContext());
    ...
    void testSelectInnerJoin() {
        ...
        var specFactory = new io.github.massimiliano.fluentsql4j.ast.visitor.PreparedStatementSpecFactory(
                io.github.massimiliano.fluentsql4j.ast.visitor.ps.AstToPreparedStatementSpecVisitor.builder()
                        .build());
    ...
    void testSelectCountGroupByHaving() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .from(From.of(new TableIdentifier("User")))
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
    ...
    void testSelectSumGroupByHavingAnd() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
                        io.github.massimiliano.fluentsql4j.ast.core.predicate.AndOr.and(
    ...
    void testSelectAvgGroupByHavingOr() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
                        io.github.massimiliano.fluentsql4j.ast.core.predicate.AndOr.or(
    ...
    void testSelectGroupByHavingBetween() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
                        new io.github.massimiliano.fluentsql4j.ast.core.predicate.Between(
    ...
    void testSelectGroupByHavingIn() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
                        new io.github.massimiliano.fluentsql4j.ast.core.predicate.In(
    ...
    void testSelectGroupByHavingNotNested() {
        SelectStatement selectStmt = SelectStatement.builder()
                ...
                .groupBy(GroupBy.of(ColumnReference.of("User", "email")))
                .having(io.github.massimiliano.fluentsql4j.ast.dql.clause.Having.of(
                        new Not(io.github.massimiliano.fluentsql4j.ast.core.predicate.AndOr.or(
    ...
    void unionOfTwoSelectStatements() {
        ...
        AstToPreparedStatementSpecVisitor specFactory = new AstToPreparedStatementSpecVisitor();
        PreparedStatementSpec result = specFactory.visit(union, new AstContext());
        assertThat(result.sql())
                .isEqualTo(
    ...
    void deleteStatement() {
        ...
        PreparedStatementSpec psNoWhere = specFactory.visit(stmtNoWhere, new AstContext());
    ...
    void createTableStatement() {
        ...
        AstToPreparedStatementSpecVisitor specFactory = new AstToPreparedStatementSpecVisitor();
        PreparedStatementSpec result = specFactory.visit(createTable, new AstContext(AstContext.Feature.DDL));
    ...
    void createTableStatementWithForeignKeyConstraint() {
        ...
        AstToPreparedStatementSpecVisitor specFactory = new AstToPreparedStatementSpecVisitor();
        PreparedStatementSpec result = specFactory.visit(createTable, new AstContext());
    ...
    void defaultConstraintIntegration() {
        ...
        PreparedStatementSpec result = specFactory.visit(constraint, new AstContext());
    ...
    void scalarSubqueryIntegration() {
        ...
        AstToPreparedStatementSpecVisitor specFactory = new AstToPreparedStatementSpecVisitor();
        PreparedStatementSpec result = specFactory.visit(subquery, new AstContext());
