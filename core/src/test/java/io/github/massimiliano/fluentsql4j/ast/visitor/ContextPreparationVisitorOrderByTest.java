...
class ContextPreparationVisitorOrderByTest {
    ...
    void orderByAfterWherePreservesWhereFeature() {
        ...
        SelectStatement statement = SelectStatement.builder()
                .from(From.fromTable("users"))
                .where(io.github.massimiliano.fluentsql4j.ast.dql.clause.Where.of(
                        io.github.massimiliano.fluentsql4j.ast.core.predicate.Comparison.eq(
    ...
    void orderByWithExpressionSortingDoesNotAddFeatures() {
        ...
        SelectStatement statement = SelectStatement.builder()
                ...
                .orderBy(OrderBy.of(Sorting.desc(
                        io.github.massimiliano.fluentsql4j.ast.core.expression.scalar.ArithmeticExpression
                                .multiplication(
    ...
    void orderByWithExistingContextPreservesAllFeatures() {
        ...
        io.github.massimiliano.fluentsql4j.ast.dql.source.join.OnJoin join =
                new io.github.massimiliano.fluentsql4j.ast.dql.source.join.OnJoin(
                        new io.github.massimiliano.fluentsql4j.ast.core.identifier.TableIdentifier("t1"),
                        io.github.massimiliano.fluentsql4j.ast.dql.source.join.OnJoin.JoinType.INNER,
                        new io.github.massimiliano.fluentsql4j.ast.core.identifier.TableIdentifier("t2"),
                        io.github.massimiliano.fluentsql4j.ast.core.predicate.Comparison.eq(
