...
public final class TestDatabaseUtil {
     ...
     *
     * <p>The table includes a primary key column "id" which is auto-generated by the
     * database using "GENERATED BY DEFAULT AS IDENTITY". This means the database will
     * assign a unique BIGINT value when an explicit id is not provided. Test code
     * typically relies on this automatic id generation. Some databases may allow
     * inserting explicit id values depending on configuration.
     *
     * @param connection the database connection used to execute the CREATE TABLE statement
     * @throws SQLException if table creation fails
     */
