...
class DefaultSubstringPsStrategyTest {

    private DefaultSubstringPsStrategy strategy;
    private PreparedStatementVisitor visitor;
    private AstContext ctx;

    @BeforeEach
    void setUp() {
        strategy = new DefaultSubstringPsStrategy();
        visitor = PreparedStatementVisitor.builder().build();
        ctx = new AstContext();
    }
