...
class DefaultBinaryArithmeticExpressionPsStrategyTest {

    private DefaultBinaryArithmeticExpressionPsStrategy strategy;
    private PreparedStatementRenderer renderer;

    @BeforeEach
    void setUp() {
        strategy = new DefaultBinaryArithmeticExpressionPsStrategy();
