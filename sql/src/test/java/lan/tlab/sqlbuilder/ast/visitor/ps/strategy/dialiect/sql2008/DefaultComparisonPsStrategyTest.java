...
class DefaultComparisonPsStrategyTest {

    private DefaultComparisonPsStrategy strategy;
    private PreparedStatementVisitor visitor;
    private AstContext ctx;

    @BeforeEach
    void setUp() {
        strategy = new DefaultComparisonPsStrategy();
    ...
    void equalsComparison() {
        ...
        PsDto result = strategy.handle(comparison, visitor, ctx);
    ...
    void allComparisonOperators() {
        ...
        assertThat(strategy.handle(Comparison.eq(ColumnReference.of("t", "c"), Literal.of("test1")), visitor, ctx)
                        .sql())
                .contains(" = ");
        assertThat(strategy.handle(Comparison.ne(ColumnReference.of("t", "c"), Literal.of("test2")), visitor, ctx)
                        .sql())
                .contains(" <> ");
        assertThat(strategy.handle(Comparison.gt(ColumnReference.of("t", "c"), Literal.of("test3")), visitor, ctx)
                        .sql())
                .contains(" > ");
        assertThat(strategy.handle(Comparison.gte(ColumnReference.of("t", "c"), Literal.of("test4")), visitor, ctx)
                        .sql())
                .contains(" >= ");
        assertThat(strategy.handle(Comparison.lt(ColumnReference.of("t", "c"), Literal.of("test5")), visitor, ctx)
                        .sql())
                .contains(" < ");
        assertThat(strategy.handle(Comparison.lte(ColumnReference.of("t", "c"), Literal.of("test6")), visitor, ctx)
                        .sql())
                .contains(" <= ");
    }
}
