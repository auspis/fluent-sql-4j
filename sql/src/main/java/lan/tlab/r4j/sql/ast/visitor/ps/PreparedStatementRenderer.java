...
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlAggregateCallPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlAggregationFunctionProjectionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlAndOrPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlAsPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlBetweenPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlBinaryArithmeticExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCastPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCharLengthPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCharacterLengthPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCheckConstraintPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlColumnDefinitionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlColumnReferencePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlComparisonPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlConcatPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCreateTableStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCurrentDatePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlCurrentDateTimePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlDateArithmeticPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlDefaultConstraintPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlDefaultValuesPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlDeleteStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlDenseRankPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlExceptExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlExtractDatePartPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlForeignKeyConstraintPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlFromClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlFromSubqueryPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlGroupByClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlHavingClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlInPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlIndexDefinitionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlInsertSourcePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlInsertStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlInsertValuesPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlIntersectExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlIntervalPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlIsNotNullPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlIsNullPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlJsonExistsPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlJsonQueryPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlJsonValuePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLagPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLeadPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLeftPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLengthPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLikePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlLiteralPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlMergeStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlModPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNotNullConstraintPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNotPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNtilePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNullPredicatePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNullScalarExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlNullSetExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlOnJoinPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlOrderByClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlOverClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlPaginationPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlParameterizedDataTypePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlPowerPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlPrimaryKeyPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlRankPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlReferencesItemPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlReplacePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlRoundPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlRowNumberPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlScalarExpressionProjectionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlScalarSubqueryPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlSelectClausePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlSelectStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlSimpleDataTypePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlSortingPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlSubstringPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlTableDefinitionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlTablePsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlTrimPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUnaryArithmeticExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUnaryNumericPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUnaryStringPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUnionExpressionPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUniqueConstraintPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUpdateItemPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlUpdateStatementPsStrategy;
import lan.tlab.r4j.sql.plugin.builtin.mysql.ast.visitor.ps.strategy.StandardSqlWhereClausePsStrategy;
...
public class PreparedStatementRenderer implements Visitor<PsDto> {
    ...
    public EscapeStrategy getEscapeStrategy() {
        return sqlRenderer.getEscapeStrategy();
    }
