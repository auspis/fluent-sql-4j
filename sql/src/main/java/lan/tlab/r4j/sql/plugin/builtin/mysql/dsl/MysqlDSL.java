...
public class MysqlDSL extends DSL {
    ...
    private ScalarExpression toScalarExpression(Object value) {
        ...
        if (value instanceof lan.tlab.r4j.sql.ast.common.predicate.Predicate predicate) {
            // Wrap predicate as an expression for use in functions like IF()
            return new lan.tlab.r4j.sql.ast.common.expression.scalar.PredicateExpression(predicate);
        }
