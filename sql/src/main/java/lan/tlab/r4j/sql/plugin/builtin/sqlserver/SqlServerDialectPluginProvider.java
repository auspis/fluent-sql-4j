...
/**
 * Service provider for the Microsoft SQL Server dialect plugin.
 * <p>
 * This class enables automatic discovery of the SQL Server dialect plugin through
 ...
 * // SQL Server plugin is now available in the registry
 * }</pre>
 *
 * @see SqlDialectPluginProvider
 * @see SqlServerDialectPlugin
 * @see java.util.ServiceLoader
 * @since 1.0
 */
public final class SqlServerDialectPluginProvider implements SqlDialectPluginProvider {

    /**
     * Returns the SQL Server dialect plugin instance.
     * <p>
     * This method is called by the {@link java.util.ServiceLoader} during plugin discovery.
     *
     * @return the SQL Server dialect plugin, never {@code null}
     */
    @Override
    public SqlDialectPlugin get() {
        return SqlServerDialectPlugin.instance();
    }
}
