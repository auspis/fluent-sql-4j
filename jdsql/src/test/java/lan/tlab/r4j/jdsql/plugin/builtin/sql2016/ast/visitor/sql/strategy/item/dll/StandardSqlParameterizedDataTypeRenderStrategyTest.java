...
class StandardSqlParameterizedDataTypeRenderStrategyTest {

    private SqlRenderer renderer;
    private StandardSqlParameterizedDataTypeRenderStrategy strategy;

    @BeforeEach
    void setUp() {
        renderer = TestDialectRendererFactory.standardSql();
        strategy = new StandardSqlParameterizedDataTypeRenderStrategy();
    }
