package lan.tlab.r4j.jdsql.ast.core.expression.function;
 ...
 *   <li>{@link lan.tlab.r4j.jdsql.ast.core.expression.aggregate.AggregateExpression}: Functions
 ...
 * <ul>
 *   <li>String functions: {@code lan.tlab.r4j.jdsql.ast.core.expression.function.string.*}
 *   <li>Numeric functions: {@code lan.tlab.r4j.jdsql.ast.core.expression.function.number.*}
 *   <li>Date/Time functions:
 *       {@code lan.tlab.r4j.jdsql.ast.core.expression.function.datetime.*}
 *   <li>JSON functions: {@code lan.tlab.r4j.jdsql.ast.core.expression.function.json.*}
 * </ul>
 *
 * @see ScalarExpression
 * @see WindowFunction
 * @see CustomFunctionCall
 * @see lan.tlab.r4j.jdsql.ast.core.expression.aggregate.AggregateExpression
 */
